...
void setup()
{
  ...
  magCalibration(MPU9250_CAM_ADDRESS, accCamBias, gyroCamBias, magCamBias, magCamScale);
...
void magCalibration(byte address, float * accBias, float * gyroBias, float * magBias, float * magScale) {
  ...
  storeMagCalibrationData(ADD_MAG_CAM_BIAS, ADD_MAG_CAM_SCALE, magBias, magScale);
